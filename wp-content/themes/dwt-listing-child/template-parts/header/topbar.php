...
if (isset($dwt_listing_options["dwt_listing_topbar"]) && $dwt_listing_options["dwt_listing_topbar"] == "1") {
    ...
    <div class="header-info-bar">
        <div class="<?php echo esc_attr($contain_class); ?>">
            <div class="row">
                <div class="<?php if(empty($dwt_listing_options["dwt_listing_slogan"])){ echo 'col-md-3'; } else { echo 'col-md-5';} ?> col-sm-5 col-xs-12">
                ...
                <div class="<?php if(empty($dwt_listing_options["dwt_listing_slogan"])){ echo 'col-md-3'; } else { echo 'col-md-2';} ?> col-sm-2 col-xs-12">
                ...
                <div class="<?php if(empty($dwt_listing_options["dwt_listing_slogan"])){ echo 'col-md-6'; } else { echo 'col-md-5';} ?> col-sm-5 col-xs-12">
                    <ul class="header-social pull-right <?php echo esc_attr($flip); ?>">
                        ...
                        if (!empty($dwt_listing_options["dwt_listing_share"])) {
                            ...
                            foreach ($dwt_listing_options["dwt_listing_share"] as $key => $value) {
                                if ($key == "Vkontakte" && $value != "") {
                                    echo "<li><a href=" . esc_url($value) . " class='social-facebook' target='_blank'><i class='fa fa-vk'></i></a></li>";
                                }
                                if ($key == "Facebook" && $value != "") {
                                    echo "<li><a href=" . esc_url($value) . " class='social-facebook' target='_blank'><i class='fa fa-facebook'></i></a></li>";
                                }
                                if ($key == "Skype" && $value != "") {
                                    echo "<li><a href=" . esc_url($value) . " class='social-skype' target='_blank'><i class='fa fa-skype'></i></a></li>";
                                }
                                if ($key == "Twitter" && $value != "") {
                                    echo "<li><a href=" . esc_url($value) . " class='social-twitter' target='_blank'><i class='fa fa-twitter'></i></a></li>";
                                }
                                if ($key == "LinkedIn" && $value != "") {
                                    echo "<li><a href=" . esc_url($value) . " class='social-linkedin' target='_blank'><i class='fa fa-linkedin'></i></a></li>";
                                }
                                if ($key == "Youtube" && $value != "") {
                                    echo "<li><a href=" . esc_url($value) . " class='social-youtube' target='_blank'><i class='fa fa-youtube'></i></a></li>";
                                }
                                if ($key == "GooglePlus" && $value != "") {
                                    echo "<li><a href=" . esc_url($value) . " class='social-google-plus' target='_blank'><i class='fa fa-google-plus'></i></a></li>";
                                }
                                if ($key == "Instagram" && $value != "") {
                                    echo "<li><a href=" . esc_url($value) . " class='social-instagram' target='_blank'><i class='fa fa-instagram'></i></a></li>";
                                }
                            }
                        }
                        ?>
