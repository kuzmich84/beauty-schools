                    ...
                    <div class="content">
                        ...
                        <div class="social-media-group">
                            <div class="social">
                                ...
                                <?php endif; ?>
                                <?php if (isset($dwt_listing_options['vk_api_key']) && $dwt_listing_options['vk_api_key'] != ""):
                                    ?>
                                    <a id="vkontakte_login" href="javascript:void(0)" class="circle facebook" onclick="hello('facebook').login({scope: 'email'})">
