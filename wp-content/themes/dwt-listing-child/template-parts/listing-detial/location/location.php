...
if(dwt_listing_text('dwt_listing_enable_map') == "1")
{
	...
	?>
        ...
        {
        ?> 
            <h3> <?php echo dwt_listing_text('dl_location'); ?>  </h3>
...
<?php
     ...
     * Вывод карты Yandex
     */
    elseif(dwt_listing_text('dwt_map_selection') == "yandex_map" && dwt_listing_text('yandex_api_key') != "")
    {
        ?>
        <?php
        if( get_post_meta($listing_id, 'dwt_listing_listing_lat', true ) != "" && get_post_meta($listing_id, 'dwt_listing_listing_long', true ) != "" )
   ...
   var lat = "' . get_post_meta($listing_id, 'dwt_listing_listing_lat', true ) . '";
   var lng =  "' . get_post_meta($listing_id, 'dwt_listing_listing_long', true ) . '";
    getYandexMap(lat, lng);
