    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(
		 ...
		 array(
            ...
            array(
                'id'    => 'dwt_listing_options_notification_yandex',
                'type'  => 'info',
                'style' => 'warning',
                'required' => array( 'dwt_map_selection', '=', 'yandex_map' ),
                'title' => __( 'Yandex Notification.', 'dwt-listing' ),
                'desc'  => __( 'Yandex <strong>maps & places</strong> will only works when you have an API key. <a href="https://developer.tech.yandex.ru/services/" target="_blank"> Yandex Notification</a>', 'dwt-listing' )
            ),

            array(
                'id'       => 'yandex_api_key',
                'type'     => 'text',
                'title'    => esc_html__( 'Yandex Map API Key', 'dwt-listing' ),
                'desc' => dwt_listing_make_link ( 'https://developer.tech.yandex.ru/services/' , esc_html__( 'How to Find it' , 'dwt-listing' ) ),
                'required' => array( 'dwt_map_selection', '=', 'yandex_map' ),
                'subtitle' => esc_html__( 'Yandex Map & search only works when you entered Yandex API Key', 'dwt-listing' ),
                'default'  => '',
            ),

            array(
                'id' => 'dwt_listing_yandex_lang',
                'type' => 'text',
                'title' => esc_html__('Yandex map language', 'dwt-listing'),
                'desc' => dwt_listing_make_link('https://tech.yandex.ru/maps/staticapi/doc/1.x/dg/concepts/localization-docpage/', esc_html__('List of available languages', 'dwt-listing')),
                'required' => array( 'dwt_map_selection', '=', 'yandex_map' ),
                'default' => 'en_US',
            ),
