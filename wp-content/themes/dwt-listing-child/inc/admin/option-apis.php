...
Redux::setSection($opt_name, array(
    ...
    'fields' => array(
        array(
            'id' => 'vk_api_id',
            'type' => 'text',
            'title' => esc_html__('Vkontakte Client ID', 'dwt-listing'),
            'desc' => dwt_listing_make_link('https://vk.com/apps?act=manage', esc_html__('How to Make', 'dwt-listing')),
        ),
        array(
            'id' => 'vk_api_key',
            'type' => 'text',
            'title' => esc_html__('Vkontakte Client Key', 'dwt-listing'),
            'desc' => dwt_listing_make_link('https://vk.com/apps?act=manage', esc_html__('How to Make', 'dwt-listing')),
        ),
        array(
