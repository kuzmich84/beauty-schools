   ...
   <div class="produt-slider owl-carousel owl-theme">
	...
	?>
            <div class="item">
                ...
                <a href="<?php echo esc_url( $full_img[0]); ?>" data-fancybox="group"><img class="img-responsive" src="<?php echo esc_url( $get_img_thumb[0]); ?>" alt="<?php esc_html__( 'dwt-listing', 'dwt-listing' ); ?>"></a>
            </div>
    <?php 	
	}
	?>
...
?>
<?php echo ''.$sale_banner; ?>
<img class="img-responsive" alt="<?php esc_html__( 'dwt-listing', 'dwt-listing' ); ?>" src="<?php echo esc_url( wc_placeholder_img_src() ); ?>">
<?php
}
?>
</div>