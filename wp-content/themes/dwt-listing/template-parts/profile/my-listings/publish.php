        ...
        <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
            <div class="panel">
                <div class="panel-heading">
                    <h3 class="panel-title"><?php echo esc_html__('Published Listings', 'dwt-listing'); ?></h3>
                </div>
                                        ...
                                        <tr class="unique-key-<?php echo esc_attr($listing_id); ?>">
                                            ...
                                            <td>
                                                <span class="action-icons active">
                                                    ...
                                                    ?>
                                                    <a class="tool-tip" title="<?php echo esc_attr__('Edit', 'dwt-listing'); ?>" href="<?php echo esc_url(dwt_listing_page_lang_url_callback($listing_publish_edit_url)); ?>"><i class="ti-pencil-alt"></i></a>
