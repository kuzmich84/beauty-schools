...
<ul>
    ...
    ?>
    <li class="list-meta-with-icons"><a class="sonu-button bookmark-listing" data-loading-text="<i class='fa fa-spinner fa-spin '></i> <?php echo esc_html__("Processing...", 'dwt-listing'); ?>" href="javascript:void(0)" data-listing-id="<?php echo esc_attr($listing_id); ?>"><i class="ti-bookmark"></i><?php echo esc_html__("Save", 'dwt-listing'); ?></a></li>
